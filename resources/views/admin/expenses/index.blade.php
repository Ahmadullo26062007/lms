...
@section('content')
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-12">
                <a class="btn btn-primary mb-3" href="{{ route('expenses.create') }}">
                ...
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Expenses Table</h6>
                            ...
                            @foreach ($expenses as $expense)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('expenses.show', $expense) }}" class="btn btn-success">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <form class="d-inline" action="{{ route('expenses.destroy', $expense) }}"
